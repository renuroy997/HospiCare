...
public class AANDEMERGENCY extends javax.swing.JFrame {
    public AANDEMERGENCY() {
        initComponents();
  data();
    }
    void data(){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HEAD PHYSICIAN :  PAVEL KUPKAR MD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AANDEMERGENCY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AANDEMERGENCY().setVisible(true);
            }
        });
         String labelContent="<html> hey </html>";
